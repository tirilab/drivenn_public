...
unii_records = pd.read_csv("data/UNII_Data/UNII_Records.txt", sep='\t', low_memory=False)
legacy_unii_records = pd.read_csv("data/UNII_Data/Legacy_UNIIs.txt", sep='\t', low_memory=False)
